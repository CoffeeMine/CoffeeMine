...
class profileView extends VerticalLayout {
    public profileView() {
        ...
        TextField salaryPerHourFiled = new TextField();
        salaryPerHourFiled.setPlaceholder("Salary per hour");
        accountStates.addFormItem(salaryPerHourFiled, "Salary per hour:");
        TextField totalHoursField = new TextField();
        totalHoursField.setPlaceholder("Total hours worked");
        accountStates.addFormItem(totalHoursField, "Total hours worked:");
